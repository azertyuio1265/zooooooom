...
app.post('/api/ai/summarize', async (req, res) => {
    try {
        ...
        try {
            ...
            const prompt = `أنت بروفيسور وعالم تربوي وأستاذ أطروحات متميز، خبير في المناهج الرسمية والبرامج التعليمية.
...
تعليمات صارمة لا تقبل التراجع لضمان فهم الطالب فهماً تاماً وعميقاً:
1. **الشرح المسهب والمعمق (Exhaustive & Detailed Explanation):**
   - ممنوع نهائياً الإيجاز أو السطحية أو الاكتفاء بعناوين عامة. اشرح الدرس نقطة بنقطة، مصطلحاً بمصطلح، وقاعدة بقاعدة وكأنك تلقي محاضرة كبرى في قاعة دراسية وتكتب كل التفاصيل على السبورة.
   - وضح الخلفية النظرية، الهدف العملي، والآلية الكامنة خلف "${cleanLesson}".
2. **الهيكل الإلزامي المفصل للدرس:**
   - **### 1️⃣ مقدمة علمية وإشكالية الدرس**: مدخل شامل، الأهمية المعرفية، ولماذا ندرس هذا الموضوع بالتحديد.
   - **### 2️⃣ الشرح المفاهيمي والنظري المفصل (شرح عميق ومتسلسل):** تفصيل دقيق لجميع المفاهيم، القواعد، النظريات، الهياكل (أو الأكواد البرمجية للغات البرمجة)، مع جداول مقارنة ومخططات تنظيمية بـ Markdown.
   - **### 3️⃣ أمثلة تطبيقية وأكواد برمجية (أو مسائل رياضية) مشروحة خطوة بخطوة:** أمثلة حقيقية مفصلة بالكامل ومصطحبة بالشرح السطري والتعليل المنطقي.
   - **### 4️⃣ تمارين مقترحة متقدمة مع الحلول النموذجية المفصلة:**
     - **#### 📝 التمرين التطبيقي الأول (مسألة أو وضعية شاملة مستوحاة من الامتحانات):** نص تمرين تفصيلي ودقيق.
     - **#### 🔑 الحل النموذجي المفصل خطوة بخطوة:** حل كامل، مشروح بالكامل، مع الخطوات، القوانين، والحسابات والنتائج.
     - **#### 📝 التمرين التطبيقي الثاني:** نص تمرين إضافي لاختبار الفهم.
     - **#### 🔑 الحل النموذجي المفصل للتمرين الثاني:** حل كامل ومفصل خطوة بخطوة.
   - **### 5️⃣ نصائح الأستاذ الخبير للتميز وضمان العلامة الكاملة.**
3. **لغة الإخراج:** باللغة العربية الفصحى الأكاديمية وبصيغة Markdown الغنية جداً والمنسقة باحترافية بالكامل.`;
