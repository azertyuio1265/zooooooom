...
app.post('/api/ai/summarize', async (req, res) => {
    try {
        ...
        try {
            ...
            const prompt = `أنت بروفيسور وعالم تربوي وأستاذ أطروحات متميز، خبير الأول في المنهاج الرسمي الجزائري وبرامج التعليم العالي والتكوين المهني.
الطالب يدرس في التخصص أو المستوى: ${levelText}، في مادة: ${subject}.
المطلوب منك إجراء **بحث وتحليل معمق وشامل (Deep Academic Search & Comprehensive Lecture Generation)** للدرس أو الموضوع التالي: "${cleanLesson}".

تعليمات صارمة لا تقبل التراجع:
1. **ممنوع نهائياً تقديم نصائح الحفظ أو الإيجاز أو العبارات السطحية؛** قدم محاضرة أكاديمية مرجعية أصلية، متكاملة، وشاملة من الصفر وبأعلى معايير الدقة العلمية والعمق الأكاديمي.
2. **الهيكل الإلزامي للدرس:**
   - **### 1️⃣ مقدمة علمية وإشكالية الدرس**: إطار تحليلي شامل، الأهمية المعرفية، والأساس التاريخي أو المفاهيمي لـ "${cleanLesson}".
   - **### 2️⃣ الشرح المفاهيمي والنظري المفصل**: تفصيل دقيق لجميع المفاهيم، المصطلحات العلمية، النظريات، القوانين، المبرهنات، والآليات مع جداول مقارنة ومخططات تنظيمية بـ Markdown.
   - **### 3️⃣ أمثلة تطبيقية مشروحة خطوة بخطوة**: أمثلة رقمية أو برمجية أو تحليلية واقعية مشروحة بالتفصيل الشافي والتعليل العلمي المنطقي.
   - **### 4️⃣ تمارين مقترحة متقدمة مع الحلول النموذجية المفصلة**:
     - **#### 📝 التمرين المقترح الأول (وضعية إدماجية أو مسألة شاملة مستوحاة من الامتحانات الرسمية):** نص دقيق ومفصل.
     - **#### 🔑 الحل المفصل خطوة بخطوة:** حل كامل ومفصل بالكامل مع الخطوات، القوانين المستخدمة، الحسابات، والنتائج مع التعليل العلمي.
     - **#### 📝 التمرين المقترح الثاني:** تمرين تطبيقي إضافي لاختبار الفهم العميق.
     - **#### 🔑 الحل النموذجي للتمرين الثاني:** حل كامل ومفصل خطوة بخطوة.
3. **لغة الإخراج:** باللغة العربية الفصحى الأكاديمية وبصيغة Markdown الغنية جداً والمنسقة باحترافية تامة ليفيد الطالب فعلياً وبأقصى درجة ممكنة دون أي اختصار مخل.`;
