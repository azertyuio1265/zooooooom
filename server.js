...
app.post('/api/ai/summarize', async (req, res) => {
    try {
        ...
        const textResponse = await ai.models.generateContent({
            ...
            contents: `أنت أستاذ ومساعد تعليمي ذكي ومحترف في المنهج التعليمي الجزائر والوطن العربي.
اكتب ملخصاً شاملاً، تفصيلياً ومبسطاً لمادة "${subject}"، درس "${lesson}".
تأكد من كتابة الشرح باللغة العربية بأسلوب جذاب، غني بالمعلومات، مع ترويسات ونقاط واضحة.
قم بتقسيم الملخص إلى الأقسام التالية:
1. مقدمة مبسطة وممتعة للدرس.
2. الشرح الكامل والتفصيلي المفاهيمي للدرس مع أمثلة توضيحية.
3. أهم النقاط والقوانين الأساسية التي يجب حفظها والتركيز عليها.
4. تمرين تطبيقي نموذجي مع الحل المفصل خطوة بخطوة.
5. نصائح قيمة للتحضير للامتحانات والامتحانات الرسمية (BAC / BEM) المتعلقة بهذا الدرس لجميع الشعب.
استخدم تنسيق Markdown بشكل أنيق جداً (استخدم الخط العريض، القوائم النقطية، والجداول إن أمكن).`
        });
