...
export declare enum AgoraAPIName {
    ...
    CREATE_CLIENT_PRECONNECT = "createClientPreconnect",
     ...
     * 远端ice参数不匹配，需要重新建立连接
     */
    MISMATCH_ICE_PARAMETERS = "mismatchIceParameters",
    /**
     * 跨区回流 CN
     */
    VOS_FALLBACK_CN = "vosFallbackCN",
    /**
     * DataChannel信令回退WebSocket
     */
    DATACHANNEL_FAILBACK = "datachannelFailback"
}
...
export declare interface AgoraTransportStats {
    bytesSent: number;
...
export declare function checkValidElement(element: any, name: string): void;
...
export declare enum ClientEvents {
    ...
    /** @internal */
    FALLBACK_TO_HLS = "fallback-to-hls",
    /** @internal */
    FIRST_VIDEO_BUFFER_READY = "first-video-buffer-ready",
    /** @internal */
    FIRST_VIDEO_PRE_RENDER = "first-video-pre-render",
    /** @internal */
    AV1_DECODABLE_RESULT = "av1-decodable-result"
}

/** @internal */
export declare enum ClientFallbackToHlsType {
    CONFIG = "config",
    VOSERROR = "vos_error",
    AP_ERROR = "ap_error"
}
...
export declare function createAxiosCancelSource(): CancelTokenSource;
...
export declare const DEFAULT_TRANSPORT_STATS: AgoraTransportStats;
...
export declare interface KeyMetrics {
    ...
    firstVideoFrameDecoded: {
        ...
        firstReceivedEncodedFrame?: number;
        frameType?: string;
        rtpTimestamp?: number;
        framePayloadType?: number;
...
export declare const MUTABLE_GATEWAY_PARAMS: {
     ...
     * 是否使用 join v4
     */
    ENABLE_JOIN_V4: boolean;
    ENABLE_AP_COMPRESS: boolean;
};
...
export declare const MUTABLE_PARAMS: {
    ...
    IGNORE_RTC_DEVICE_CHECK: boolean;
    /**
     * fls 保留字段，后续权衡后，可删除
     */
    FLS_AUTOPLAY_EMITS: boolean;
    /**
     * join 信令里, 表示新版本的主播流，需要带flag
     */
    ENABLE_DUAL_STREAM_FLAG: boolean;
    /**
     * 禁止修改 local offer sdp
     */
    FORBID_MODIFY_LOCAL_OFFER_SDP: boolean;
    /**
     * 保留 mid 1 的 m-line
     */
    RESERVE_MID_1_MLINE: boolean;
    /**
     * 预订阅数目
     * 因为 sdp endpoint 模式下，joinGateway 之前就开始用了，所以不能在 joinGateway 之前设置
     */
    PRE_SUB_NUM: number;
    /**
     * only for test
    ...
    DC_IN_ESM: boolean;
    /**
     * PRE PLAYOUT DELAY HINT, use playoutDelayHint in browser
     */
    PRE_PLAYOUT_DELAY_HINT: any;
    INSTALL_ID: string;
    /**
     ...
     * 下发当前客户流
     */
    REMOTE_VIDEO_STREAM_TYPE: number | undefined;
    ...
    ENABLE_SVC: boolean;
    ENABLE_FORCE_HLS: boolean;
    MAX_WEBAUDIO_VOLUME: number;
    /**
     * 是否允许服务端下发 code 30 消息
     */
    ENABLE_VOS_FALLBACK: boolean;
    /**
     * 是否允许服务端下发 code fallback hls
     */
    ENABLE_FALLBACK_TO_HLS: boolean;
    /**
     * 开启预渲染
     */
    ...
    SDP_ENDPOINT_DOMAIN: string[];
    SDP_ENDPOINT_DOMAIN_BACKUP_LIST: string[];
    PROXY_CS: string[];
    CDS_AP: string[];
     ...
     * 老鉴黄 wss
     */
    VIDEO_INSPECT_WORKER_MANAGER_WSS: string;
    ...
    /** 鉴黄wss */
    IMAGE_MODERATION_WORKER_WSS: string;
    ...
    DC_CONNECTION_TIMEOUT: number;
    DC_PINGPONG_INTERVAL: number;
    /**
     * 是否开启datachannel的debug log
     */
    DC_DEBUG_LOG: boolean;
    /**
    ...
    ENABLE_CREATE_CLIENT_PRECONNECT: boolean;
    CREATE_CLIENT_PRECONNECT_MODE: string;
    CREATE_CLIENT_PRECONNECT_KEEPALIVE: boolean;
    CREATE_CLIENT_PRECONNECT_INTERVAL_MS: number;
    /**
    ...
    /**
     * 允许出现的最大 API 错误次数，超过此次数将清除本地配置缓存
     * */
    MAX_CONFIG_RETRY: number;
    /**
     * 开启配置下发兜底策略，防止大批量出现问题
     * */
    ENABLE_CONFIG_RESTORE: boolean;
    /**
     * 需要进行配置恢复的 error api 列表
     */
    CONFIG_RESTORE_ERROR_API: string[];
    /**
     * api 异常捕捉，针对一些非预期的错误码 来处理
     */
    CONFIG_ERROR_MONITOR: string[];
    /**
     * 问题配置 block 的时间，用于后续恢复
     */
    BLOCKED_CONFIG_MAX_TIME: number;
    /**
     * 第一次补充tcp 时间间隔
     */
    ...
    TURN_DOMAIN: string;
    /**
     * 4.24.1 之后，以后改用 TURN_DOMAINS 来控制 TURN 域名
     */
    TURN_DOMAINS: string[];
    /**
     ...
     * FLS Fallback 参数
     */
    FLS_FALLBACK_TIMEOUT: number;
    /**
     * rte detail 计量上报间隔
     */
    RTE_DETAIL_REPORT_INTERVAL: number;
    /**
     * 编码失败 解码失败 点数判断
     */
    ...
    /**
     * 只有 host 更新 rtp capability 通知
     */
    UPDATE_RTP_CAP_IN_HOST: boolean;
    /**
     * IOS Background Track
     */
    IOS_BG_TAG: boolean;
    /**
     * IOS AUTO RESTART BACKGROUND
     */
    IOS_AUTO_RESTART_BG_TAG: boolean;
    /**
     * 忽略 UID 校验
     */
    IGNORE_UID_CHECK: boolean;
    ENABLE_UP_SPS_PPS: boolean;
    ENABLE_DOWN_SPS_PPS: boolean;
    /**
     * 针对慧直播场景，分配不到 边缘节点， 直接fallback
     */
    NO_EDGES_RETRY: boolean;
    BUFFER_READY_FRAMES: number;
    FLS_SYNC_AV_PLAY_LIMIT: number;
    FLS_BUFFER_WAIT_TIME: number;
    VOS_CONFIGURE: any;
    ENABLE_QUALITY_FALLBACK: boolean;
    QUALITY_FALLBACK_REHEARSAL: boolean;
    ENABLE_FLS_AV1_FIRST: boolean;
    ENABLE_AP_MULTI_IP: boolean;
    FLS_ENABLE_AV1_DETECT: boolean;
    FLS_ENABLE_AV1_DECODE_DETECT: boolean;
    ENABLE_SDP_ENDPOINT_LOG: boolean;
    REMOTE_VIDEO_FREEZE_TIME_VERSION: number;
};
...
export declare interface PreSubOptions {
    uid: UID;
    mediaType: "video" | "audio";
    element: string | HTMLElement | HTMLVideoElement;
    config?: {
        mirror?: boolean;
...
export declare class SDKStore {
    private state;
    constructor(codec: SDK_CODEC, audioCodec: SDK_AUDIO_CODEC, mode: SDK_MODE, clientId: string, useDcSignal: boolean);
    private dispatch;
    get useDcSignal(): boolean;
    set useDcSignal(val: boolean);
    set autoSubscribe(val: boolean);
    get autoSubscribe(): boolean;
    set autoReceiveAndPlayAudio(val: boolean);
    get autoReceiveAndPlayAudio(): boolean;
    set enableInstantMuteRestore(val: boolean);
    get enableInstantMuteRestore(): boolean;
    set networkQualityProbe(val: boolean);
    get networkQualityProbe(): boolean;
    set preSubOptions(options: PreSubOptions[]);
    get preSubOptions(): PreSubOptions[] | undefined;
    set sessionId(sessionId: string | null);
    get sessionId(): string | null;
    set rteUrl(rteUrl: string);
    get rteUrl(): string | undefined;
    set rteSid(rteSid: string);
    get rteSid(): string | undefined;
    set cid(cid: number);
 ...
 * <br>&emsp;&emsp;&emsp;4.24.1</br>
 */
export declare enum SIMULCAST_STREAM_MODE {
    /**
