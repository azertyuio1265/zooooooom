...
import { UID, MutableParamsConfig, EventEmitter, ConnectionState, SDK_MODE, ClientRole, SIMULCAST_STREAM_MODE, ClientRoleOptions, TurnServerConfig, RTMConfiguration, EncryptionMode, NetworkQuality, LocalAccessPointConfig, ConnectionDisconnectedReason, ClientConfig, KeyMetrics, P2PTransportType, JoinChannelServiceRecord, ElectronDesktopCapturerSource, RetryConfiguration, setParameter as setParameter$1 } from '@agora-js/shared';
...
interface ConfigDistributeConfigs {
    [key: string]: {
        tag: string;
        value: MutableParamsConfig;
    };
}
...
declare class AgoraRTCClient extends EventEmitter implements IAgoraRTCClient {
    ...
    private _pendingRtpCapabilityChange?;
    private _fallbackServerInfo?;
    private _dualStreamMode?;
    ...
    private _handleFullDatachannel;
    private _handleDataChannelAdded;
    private _handleDataChannelUpdated;
    private _handleDataChannelDeleted;
...
declare function checkSystemRequirements(checkMediaDevice?: boolean): boolean;
...
declare function startLastmileProbeTest(appId: string, channel: string, token: string | null, uid: string): Promise<LastmileProbeResult>;
...
declare function requestConfigDistribute(joinInfo: {
    appId: string;
    sid: string;
    cname: string;
    uid?: number | null;
    stringUid?: string;
}, cancelToken: CancelToken, retryConfig: RetryConfiguration): Promise<ConfigDistributeConfigs | undefined>;

declare function isAV1Decodable(): Promise<unknown>;
...
export { AREAS, AgoraRTC, ChannelMediaRelayError, ChannelMediaRelayEvent, type ChannelMediaRelayInfo, ChannelMediaRelayState, DEV, ESM, ESM_BUNDLER, type IAgoraRTC, type IAgoraRTCClient, type IAgoraRTCRemoteUser, type IChannelMediaRelayConfiguration, type IJoinOptions, type InspectConfiguration, type LastmileProbeResult, type LiveStreamingTranscodingConfig, type LiveStreamingTranscodingImage, type LiveStreamingTranscodingUser, UMD, __CLIENT_LIST__, checkAudioTrackIsActive, checkSystemRequirements, checkVideoTrackIsActive, createChannelMediaRelayConfiguration, createClient, disableLogUpload, enableLogUpload, getCameras, getDevices, getMicrophones, getPlaybackDevices, getSupportedCodec, isAV1Decodable, onAudioAutoplayFailed, onAudioContextStateChanged, onAutoplayFailed, onCameraChanged, onMicrophoneChanged, onSecurityPolicyViolation, preload, processExternalMediaAEC, registerExtensions, requestConfigDistribute, resumeAudioContext, setAppType, setArea, setLogLevel, setParameter, startLastmileProbeTest };
